...
function AdminOrder(props) {
    ...
    const getData = async () => {
        const res = await axios.get('http://127.0.0.1:8000/api/adminViewOrders', {
            headers: {
...
let root = document.getElementById('adminOrders')
if (root) {
    ReactDOM.render(<AdminOrder {...(root.dataset)} />, root);
}